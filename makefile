...
## —— Project 🚀  ————————————————————————————————————————————————————————
start: docker-up serve proxy composer-install js-install permissions js-dev security status ## Start Symfony binary server, install composer, fix permissions and build JS assets

stop: unserve  ## Stop Symfony binary server
...
info:
	@echo ============================================================================
	@echo PhpMyAdmin UI - Manage/View MySql datas     :     http://127.0.0.1:4244
	@echo ----------------------------------------------------------------------------
	@echo Mailhog UI    - Email smtp for tests        :     http://127.0.0.1:4246
	@echo ----------------------------------------------------------------------------
...
composer-update: composer.lock ## Install vendors according to the current composer.lock file
	$(COMPOSER) update
...
tests: ## Launch all tests with PHPUNIT
	$(PHP) bin/phpunit
